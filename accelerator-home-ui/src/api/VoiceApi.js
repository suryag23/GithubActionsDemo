  ...
  voiceSessionAudioStreamStart(params) {
    return new Promise((resolve) => {
      ...
      this.thunder.call('org.rdk.VoiceControl', 'voiceSessionAudioStreamStart', params).then(result => {
        this.INFO("VoiceApi: voiceSessionAudioStreamStart : " + "Error in Thunder VoiceApi voiceSessionRequest "+JSON.stringify(params) + " result: ", JSON.stringify(result))
        resolve(result);
      }).catch(err => {
  ...
  voiceStatus() {
    return new Promise((resolve) => {
      ...
      this.thunder.call('org.rdk.VoiceControl', 'voiceStatus').then(result => {
        this.INFO("VoiceApi: voiceStatus result: ", "Error in Thunder VoiceApi voiceSessionRequest "+JSON.stringify(result))
        resolve(result);
      }).catch(err => {
